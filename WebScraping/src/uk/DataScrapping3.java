	...
	public static void main(String[]args) throws InterruptedException, IOException{
		 try{
		     ...
		     int year = 2007;
		      ...
		      String yearhref = debatesYearLinks.getElement(9).getAt("href");
		      System.out.println("the href of year 2015-2016 is " + yearhref);
		      
		      userAgent.visit(yearhref);
		      Elements mpsList = userAgent.doc.findEvery("<p class=\"eightpointtext\">"); //list with Groups on MP names sorted by letters
		    ...
		    for(int k = 19; k < 26; k++){  //size 24 for each alphabet
		      //for(int k = 0; k < 5; k++){
		      Elements mpNameList = mpsList.getElement(k).findEach("<a href");
		      Thread.sleep(5000);
		      //start of id="loopC"
		     ...
		     //csvWriter(polParty);
		     String getMPSubjectsPageHref = userAgent.doc.findEvery("<p>").getElement(8).getFirst("<a").getAt("href"); //gets the href for the subject to which the MP spoke about
