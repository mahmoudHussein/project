...
public class ScrapingTest {
	...
	public static void csvWriter(String[] x) throws IOException{
		FileWriter mFileWriter = new FileWriter("M:\\masters\\semester 4\\web scraping\\output files\\PoliticianToParties.csv", true);
	...
	public static void main(String[]args) throws InterruptedException, IOException{
		 try{
			 ...
			 UserAgent userAgent = new UserAgent();                       //create new userAgent (headless browser).
		      ...
		      //start of id="loopB"
		      for(Element NameList: mpsList){
		      Elements mpNameList = NameList.findEach("<a");
		      Thread.sleep(5000);
		      //start of id="loopC"
